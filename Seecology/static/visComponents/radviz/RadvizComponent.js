	...
	* ########################################################################################################################################*/
	object.render = function(){
		...
		if(!svg){ //### RENDER FIRST TIME ###		
			...
			$el2 = d3.select("rv2"); // Sliders para controlar os dados
			$el3 = d3.select("rv3"); // Estatísticas dos dados selecionados e botões de comando para Keep e Exclude(Filter)
	        ...
	        //Ach oque tenho que modificar este link para funcionar
	        ...
	        var labelNodes = root.selectAll("circle.label-node")
	        	...
	        	.enter().append("circle")
	        		.style("fill", function(d, i){ 
	        			...
	        			//return colorScaleDimensions(dimensions[i].cluster-1) 
	        		})
	        ...
	        //console.log(360/dimensions.length);
	        ...
	        var nodes = root.selectAll("circle.dot").data(data).enter().append("circle")
	        	...
	        	function(d) {
		            if (useTooltip) {
		                ...
		                //tooltip.setText(tooltipFormatter(d)).setPosition(mouse[0]-100, mouse[1]+50).show();
...
//		        })
		        ...
		        function(d) {
		        	...
		        	//console.log(document.getElementById('audioRate').value);
		        	
		        	
		        	
		        	
		        	//Line chart
//		        	csvFile1 = "../../FILES/FET/"+currentDatabase+"/Extraction/AudioFeatures/"+d['FileName']+".csv";
//		        	d3.csv(csvFile1, function (error, singleData) {
//		        		
//		        		singleData.forEach(function (d, i) {
...
//		        		
//                        line1.mean(-1).data(singleData).render();
//                    });
		        	singleData = [];
		        	singleDataMean = [];
		        	data.forEach(function (dd, i) {
                        ...
                        //singleData.x = +d['SecondsFromStart'];
                        //singleData.y = +d[currentFeature];
                    });		        	
	        ...
	        enterSelection.selectAll("text")
			  ...
			  .enter().append("text")
			    ...
			    .attr("x", 7)//$el4.node().getBoundingClientRect().width/2)
...
//	        $el2.html($el2.html()+"<br><b>Ajust Feature Strenght</b>");
//	        
//	        sliderNode = [];
//	        		        	
//        	var slider0 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(0),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider0.value());}
//	        });
//        	
//        	var slider1 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(1),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider1.value());}
//	        });
//        	
//        	var slider2 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(2),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider2.value());}
//	        });
//        	
//        	var slider3 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(3),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider3.value());}
//	        });
//        	
//        	var slider4 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(4),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider4.value());}
//	        });
//        	
//        	var slider5 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(5),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider5.value());}
//	        });
//        	
//        	var slider6 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(6),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider6.value());}
//	        });
//        	
//        	var slider7 = sliderComponent({
//	            container   : $el2,
//	            min			: -10,
//	            max			: 10,
//	            value       : 0,
//	            color		: colorScaleDimensions(7),
//	            width	    : $el2.node().getBoundingClientRect().width,
//	            event		: function(){ console.log(slider7.value());}
//	        });
//	        	
//        	for (i = 0; i < dimensions.length; i++) {	
//	        	sliderNode.push(eval("slider"+i).render());
//	        };
